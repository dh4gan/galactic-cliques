...
# Repeats MCR analysis over various values of the standard deviation of civilisation lifetime
...
sigma_life_values = [0.1, 0.5, 1, 5, 10]
...
for sigma_life in sigma_life_values:
    ...
    print "Writing data for sigma_life ", sigma_life, "to file ",outputfile
...
print "MCR complete for all values of sigma_life"
