...
for i in range(3):
    ...
    data = np.genfromtxt(filenames[i], skiprows=1,usecols=(0,9,10))    
...
#ax.set_xscale('log')
ax.set_xlim(0,4000)
ax.set_ylabel(r'Group Arrival Time $(Myr)$',fontsize=20)
ax.set_xlabel(r'$N_{civ}$',fontsize=20)
fig1.savefig('grouparrive_vs_nciv.png', format='png')
